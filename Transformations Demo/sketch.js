...
function draw() {
  ...
  //push(); // creats a copy of the current coordinates
  //translate(100,100); // moves to origin
  //drawBasicGrid(100);
  //rectangleRed(0,0);
  //pop(); // discard coordiante system, return to precice
  ...
  //translate(100,100);
  //scale(scaleAmount); // 1 - nochange <1 smaller
